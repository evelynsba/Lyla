...
class Appointment
{
	public $base_url = 'http://localhost/tutorial/lyla_beauty/';
	public $connect;
	public $query;
	public $statement;
	public $now;
	...
	{
		$this->connect = new PDO("mysql:host=localhost;dbname=lyla_beauty", "root", "");
	...
	function get_total_today_appointment()
	{
		...
		WHERE professional_schedule_date = CURDATE() 
		";
		$this->execute();
	...
	function get_total_yesterday_appointment()
	{
		...
		INNER JOIN professional_schedule_table 
		ON professional_schedule_table.professional_schedule_id = appointment_table.professional_schedule_id 
		WHERE professional_schedule_date = CURDATE() - 1
		";
		$this->execute();
		return $this->row_count();
	}
	...
	function get_total_seven_day_appointment()
	{
		...
		INNER JOIN professional_schedule_table 
		ON professional_schedule_table.professional_schedule_id = appointment_table.professional_schedule_id 
		WHERE professional_schedule_date >= DATE(NOW()) - INTERVAL 7 DAY
		";
		$this->execute();
		return $this->row_count();
	}
